-- Production safe-delete policy rejects unrestricted DELETE statements, including inside RPC functions.
-- Every POS variant is rebuilt from retained snapshots, but keep the reset explicit and safely scoped to valid product associations.
