...
export default function Admin() {
  ...
  return <div className="admin-app">
    ...
    <main className="admin-workspace">
      <header className="admin-topbar"><div><p className="eyebrow">ORANGE STORE OPS</p><h1>{workspaceMeta.find(item => item.id === workspace)?.label}</h1></div><div className="admin-session"><ShieldCheck aria-hidden="true" /><span>Admin session active</span></div></header>
